...
public:
    ...
    qstr ffbSimulateThread_WheelDeviceOpenErrorMsg = QStringLiteral("力反馈模拟: 转向轴设备连接失败, 请检查该设备与电脑的连接是否正常.");
    ...
    qstr ffbSimulateThread_steeringWheelDeviceErrorMsg = QStringLiteral("开启力反馈模拟失败: 当前设置的转向设备 \"%1\" 未连接 或者 该设备不支持力反馈");
    ...
    qstr titleSpringGain = QStringLiteral("回正力强度百分比");
    qstr titleDampingGain = QStringLiteral("转向阻尼强度百分比");
    ...
    qstr speedUpDesc = QStringLiteral("游戏内车辆的加速能力, 值越小加速能力越强");
    qstr speedDownDesc = QStringLiteral("游戏内车辆的减速能力, 值越小减速能力越强");
    qstr maxSpeedDesc = QStringLiteral("游戏内车辆的极速");
